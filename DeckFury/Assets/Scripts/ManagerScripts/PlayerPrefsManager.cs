...
public class PlayerPrefsManager : MonoBehaviour
{
    ...
    public static void SetAudioPref(AudioKeys audioKey, float value) => PlayerPrefs.SetFloat(audioKey.ToString(), value);
    public static float GetAudioPref(AudioKeys audioKey) => PlayerPrefs.GetFloat(audioKey.ToString(), float.NaN);

    public static void SetCursorSensitivity(float value) => PlayerPrefs.SetFloat(GameplayKeys.CursorSensitivity.ToString(), value);
    public static float GetCursorSensitivity() => PlayerPrefs.GetFloat(GameplayKeys.CursorSensitivity.ToString(), float.NaN);

    public static void SetUseRelativeAiming(bool value) => PlayerPrefs.SetInt(GameplayKeys.UseRelativeAiming.ToString(), value ? 1 : 0);
    public static bool GetUseRelativeAiming() => PlayerPrefs.GetInt(GameplayKeys.UseRelativeAiming.ToString(), 0) == 1;

    public static void SetGlobalCameraShakeMultiplier(float value) => PlayerPrefs.SetFloat(GameplayKeys.CameraShakeMultiplier.ToString(), value);
